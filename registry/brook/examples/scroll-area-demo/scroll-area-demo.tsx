import {
  ...
  ScrollAreaThumb,
  ScrollAreaViewport,
} from "@/registry/brook/ui/scroll-area/scroll-area";
      ...
      <ScrollAreaViewport className={styles.viewport}>
        <ScrollAreaContent>
          <p className={styles.paragraph}>
            ...
            Proxima Centauri, our nearest stellar neighbor, had been traveling for over four years just to reach her eyes
            tonight.
          </p>
          <p className={styles.paragraph}>
            But here was the beautiful part: she was made of stars too. The iron in her blood, the calcium in her bones,
            the oxygen in every breath, all of it was forged in the nuclear furnaces of dying stars billions of years ago.
            When ancient supernovae exploded in spectacular deaths, they scattered these elements across the cosmos like
            cosmic seeds, eventually finding their way into planets, oceans, and somehow, into her.
          </p>
          <p className={styles.paragraph}>
          ...
          <p className={styles.paragraph}>
            ...
            not an accident but an inevitability. Perhaps matter had always been destined to organize itself into patterns
            complex enough to look back at the stars and ask why. Perhaps the atoms in her brain, once scattered across
            the void, had finally found a way to contemplate their own journey home.
          </p>
          <p className={styles.paragraph}>
            And in that moment, standing beneath the ancient light of distant suns, she realized the profound truth that
            she was neither separate from the cosmos nor insignificant within it. She was exactly what happens when stars
            dream, when the universe learns to think, when infinity folds itself into a single point of awareness and
            whispers: I am here, I am alive, I am home.
          </p>
        </ScrollAreaContent>
      </ScrollAreaViewport>
