...
function SliderControl({ className, ...props }: React.ComponentProps<typeof Slider.Control>) {
  return <Slider.Control className={cn(styles.control, className)} {...props} />;
}
...
function SliderIndicator({ className, ...props }: React.ComponentProps<typeof Slider.Indicator>) {
  return <Slider.Indicator className={cn(styles.indicator, className)} {...props} />;
}
...
function SliderValue({ className, ...props }: React.ComponentProps<typeof Slider.Value>) {
