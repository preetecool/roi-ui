...
function PopoverTrigger({ className, render, ...props }: React.ComponentProps<typeof Popover.Trigger>) {
...
function PopoverBackdrop({ className, ...props }: React.ComponentProps<typeof Popover.Backdrop>) {
  return <Popover.Backdrop className={cn(styles.backdrop, className)} {...props} />;
}

function PopoverPositioner({ className, ...props }: React.ComponentProps<typeof Popover.Positioner>) {
  return <Popover.Positioner className={cn(styles.positioner, className)} {...props} />;
}
...
function PopoverContent({ className, style, ...props }: React.ComponentProps<typeof Popover.Popup>) {
  return (
    <PopoverPortal>
