  ...
  const renderAssignees = () => {
    ...
    if (task.assignees.length > 0) {
      return (
        <Button
          ...
          className="!h-auto !p-0 flex items-center border-none bg-transparent hover:bg-transparent"
          onClick={() => onEdit?.(task)}
          variant="ghost"
        >
          {task.assignees.slice(0, 3).map((user) => (
            <div className="-ml-2 first:ml-0" key={user.id}>
              <Avatar className="h-6 w-6 text-[0.5rem] shadow-[inset_0_0_0_0.5px_oklch(from_var(--border)_l_c_h_/_0.1)]">
          ...
          {task.assignees.length > 3 && (
            <div className="-ml-2 flex h-6 w-6 items-center justify-center rounded-full bg-muted font-medium text-[0.5rem] text-muted-foreground shadow-[inset_0_0_0_0.5px_oklch(from_var(--border)_l_c_h_/_0.2)]">
              +{task.assignees.length - 3}
            </div>
          )}
        </Button>
    ...
    return (
      ...
      >
        ...
        <div className="-ml-2 flex h-6 w-6 items-center justify-center rounded-full bg-[var(--mix-card-33-bg)] text-muted-foreground shadow-[inset_0_0_0_0.5px_oklch(from_var(--border)_l_c_h_/_0.2)]">
        ...
        <CardFooter className="flex items-center justify-between gap-2 p-0">
          <div className="flex items-center gap-2">
            ...
            <Button
              aria-label="Comments"
              className={cn(
                "!h-auto !px-2 !py-1 flex items-center justify-center gap-1",
