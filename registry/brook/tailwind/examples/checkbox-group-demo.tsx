  ...
  return (
    <div className="max-w-96">
      ...
      <CheckboxGroup defaultValue={["design"]}>
        <label className="mb-2 flex cursor-pointer items-center gap-2" htmlFor="design">
        ...
        <label className="mb-2 flex cursor-pointer items-center gap-2" htmlFor="development">
        ...
        <label className="flex cursor-pointer items-center gap-2" htmlFor="marketing">
