  ...
  return (
    <div className="flex flex-col gap-3 p-8 max-sm:p-4">
      ...
      <div className="relative w-[300px] max-sm:w-full">
        ...
        >
          <div className="relative flex w-full items-center border-none rounded-[var(--radius)] bg-[var(--mix-card-50-bg)] pr-2 shadow-[0_0_0_1px_oklch(from_var(--border)_l_c_h_/_0.5)] focus-within:shadow-[0_0_0_1px_var(--ring),0_0_4px_oklch(from_var(--border)_l_c_h_/_0.5)] [&:hover_[data-slot=combobox-trigger]]:opacity-50" ref={anchorRef}>
