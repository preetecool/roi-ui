  ...
  return (
    <div className="p-8 max-sm:p-4">
      ...
      <Autocomplete
        ...
        value={value}
      >
        <div className="flex w-[300px] items-center gap-2 border-none rounded-[var(--radius)] bg-[var(--mix-card-50-bg)] pr-2 shadow-[0_0_0_1px_oklch(from_var(--border)_l_c_h_/_0.5)] focus-within:shadow-[0_0_0_1px_var(--ring),0_0_0_3px_oklch(from_var(--ring)_l_c_h_/_0.2)] max-sm:w-full">
          <AutocompleteInput
