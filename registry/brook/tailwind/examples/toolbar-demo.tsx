...
import { Toolbar, ToolbarLink, ToolbarSeparator } from "@/registry/brook/tailwind/ui/toolbar";
import {
  Tooltip,
  TooltipArrow,
  TooltipPopup,
...
export default function ToolbarDemo() {
  return (
    <TooltipProvider delay={300}>
      <div className="scrollbar-thin scrollbar-color-[--muted-foreground_transparent] w-full overflow-x-auto overflow-y-hidden [-webkit-overflow-scrolling:touch] min-[400px]:w-fit min-[400px]:overflow-x-visible [&::-webkit-scrollbar-thumb:hover]:bg-foreground [&::-webkit-scrollbar-thumb]:rounded [&::-webkit-scrollbar-thumb]:bg-muted-foreground [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar]:h-1.5 [&>*]:w-max [&>*]:min-w-full min-[400px]:[&>*]:w-auto min-[400px]:[&>*]:min-w-0">
        <Toolbar>
          ...
          <ToolbarLink aria-label="Help" className="mr-1" href="#">
            Help
          </ToolbarLink>
        </Toolbar>
      </div>
