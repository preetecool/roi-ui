...
export default function DrawerNonModal() {
  return (
    <Drawer disablePointerDismissal modal={false} swipeDirection="right">
      ...
      <DrawerPortal>
        <DrawerViewport className="pointer-events-none items-stretch justify-end p-[var(--viewport-padding)] [--viewport-padding:0px] supports-[-webkit-touch-callout:none]:[--viewport-padding:0.625rem]">
          <DrawerPopup
            className={cn(
              "w-[calc(20rem+var(--bleed))] max-w-[calc(100vw-3rem+var(--bleed))] [--bleed:3rem]",
              "!max-h-none !mb-0 !rounded-none h-full",
              "-mr-[var(--bleed)] p-6 pr-[calc(1.5rem+var(--bleed))]",
              "pointer-events-auto touch-auto overflow-y-auto overscroll-contain",
              ...
              "supports-[-webkit-touch-callout:none]:mr-0 supports-[-webkit-touch-callout:none]:[--bleed:0px]",
