        ...
        <DrawerViewport className="touch-none">
          <DrawerPopup
            className={cn(
              ...
              "after:pointer-events-none after:absolute after:inset-x-0 after:top-full after:h-[var(--bleed)] after:bg-[var(--mix-card-5-bg)] after:content-['']",
              "data-[starting-style]:!pb-0 data-[starting-style]:[transform:translateY(100%)]",
              "data-[starting-style]:shadow-[0_-16px_48px_rgb(0_0_0/0),0_6px_18px_rgb(0_0_0/0),0_0_0_1px_oklch(from_var(--border)_l_c_h/0)]",
              "data-[ending-style]:!pb-0 data-[ending-style]:[transform:translateY(100%)]",
          ...
          >
            <div className="shrink-0 touch-none border-border border-b px-6 pt-3.5 pb-3">
              <div className="mx-auto mb-2.5 h-1 w-12 shrink-0 rounded-full bg-border" />
              <DrawerTitle className="m-0 cursor-default text-center">Discover</DrawerTitle>
            </div>
            <DrawerContent className="min-h-0 max-w-none flex-1 touch-auto overflow-y-auto overscroll-contain px-6 pt-4 pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))]">
              <div className="mx-auto w-full max-w-[350px]">
                ...
                <div aria-hidden className="mb-6 grid gap-3">
                  {Array.from({ length: 20 }, (_, index) => (
                    <div
                      className="h-12 rounded-[calc(var(--radius)-2px)] border border-border bg-accent"
                      key={index}
                    />
                  ))}
                </div>
