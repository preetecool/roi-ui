...
export default function CommandDemo() {
  return (
    <Command className="border border-[var(--border)] shadow-[var(--shadow-lg)] bg-[var(--background)] [&_[cmdk-root]]:px-1 [&_[cmdk-item]]:min-h-[2.5rem] [&_[cmdk-item]]:!py-[0.625rem] [&_[cmdk-item]]:!px-[0.375rem] [&_[cmdk-item]]:font-normal [&_[cmdk-item]]:border [&_[cmdk-item]]:border-transparent [&_[cmdk-item]_svg]:text-[var(--muted-foreground)] [&_[cmdk-item]:hover]:bg-[var(--mix-card-50-bg)] [&_[cmdk-item][data-selected=true]]:bg-[var(--mix-card-50-bg)] [&_[cmdk-group]_[cmdk-group-heading]]:!normal-case [&_[cmdk-list]]:scrollbar-thin [&_[cmdk-list]]:scrollbar-track-transparent [&_[cmdk-list]]:scrollbar-thumb-[var(--mix-border-50-trans)] hover:[&_[cmdk-list]]:scrollbar-thumb-[var(--mix-border-70-trans)] [&_[cmdk-list]]:scrollbar-thumb-rounded">
      <CommandInput
