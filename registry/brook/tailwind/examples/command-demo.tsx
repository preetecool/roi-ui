...
export default function CommandDemo() {
  return (
    <Command className="[&_[cmdk-item]]:!min-h-[2.5rem] [&_[cmdk-item]]:!px-[0.375rem] [&_[cmdk-item]]:!py-[0.625rem] [&_[cmdk-item]]:!border [&_[cmdk-item]]:!border-solid [&_[cmdk-item]]:!border-transparent [&_[cmdk-item]]:!leading-[1.15] [&_[cmdk-group]_[cmdk-group-heading]]:!normal-case [&_[cmdk-list]]:!flex-[1_1_0%] [&_[cmdk-list]]:!min-h-0 [&_[cmdk-list]]:!max-h-none [&_[cmdk-list]]:scrollbar-thin [&_[cmdk-list]]:scrollbar-track-transparent [&_[cmdk-list]]:scrollbar-thumb-[var(--mix-border-50-trans)] [&_[cmdk-list]]:scrollbar-thumb-rounded-[3px] hover:[&_[cmdk-list]]:scrollbar-thumb-[var(--mix-border-70-trans)] h-[440px] border border-[var(--border)] bg-[var(--background)] shadow-[var(--shadow-lg)] [&[cmdk-root]]:flex [&[cmdk-root]]:flex-col [&[cmdk-root]]:pt-0 [&[cmdk-root]]:pb-1 max-sm:[&[cmdk-root]]:p-0 max-sm:[&_[cmdk-group]_[cmdk-group-heading]]:px-2.5 max-sm:[&_[cmdk-group]_[cmdk-group-heading]]:text-[0.8125rem] [&_[cmdk-item]:hover]:bg-[var(--mix-card-50-bg)] [&_[cmdk-item][data-selected=true]]:bg-[var(--mix-card-50-bg)] [&_[cmdk-item]]:font-normal max-sm:[&_[cmdk-item]]:min-h-[2.75rem] max-sm:[&_[cmdk-item]]:px-2.5 max-sm:[&_[cmdk-item]]:py-3 max-sm:[&_[cmdk-item]]:text-[0.9375rem] [&_[cmdk-item]_svg]:text-[var(--muted-foreground)] [&_[cmdk-list]]:overflow-y-auto [&_[cmdk-list]]:pb-0">
      <CommandInput
      ...
      <div className="-mx-1 -mb-1 flex shrink-0 items-center gap-3 border-[oklch(from_var(--border)_l_c_h_/_0.5)] border-t-[0.5px] bg-[var(--mix-muted-20-trans)] px-4 py-3 max-sm:m-0 max-sm:px-4 max-sm:py-2.5">
