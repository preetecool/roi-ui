...
const inputVariants = cva(
  [
    ...
    "focus:outline-none focus:border-ring focus:shadow-[0_0_0_2px_var(--ring)/0.2]",
    "focus-visible:outline-none focus-visible:border-ring focus-visible:shadow-[0_0_0_2px_var(--ring)/0.2]",
    "data-[focused]:outline-none data-[focused]:border-ring data-[focused]:shadow-[0_0_0_2px_var(--ring)/0.2]",
