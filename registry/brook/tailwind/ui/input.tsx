...
const inputVariants = cva(
  [
    ...
    "focus:shadow-[0_0_0_1px_var(--ring),0_0_4px_oklch(from_var(--border)_l_c_h_/_0.5)] focus:outline-none",
    "focus-visible:shadow-[0_0_0_1px_var(--ring),0_0_4px_oklch(from_var(--border)_l_c_h_/_0.5)] focus-visible:outline-none",
    "data-[focused]:shadow-[0_0_0_1px_var(--ring),0_0_4px_oklch(from_var(--border)_l_c_h_/_0.5)] data-[focused]:outline-none",
    "data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50",
    "data-[invalid]:shadow-[0_0_0_1px_var(--destructive)]",
    "data-[invalid]:data-[focused]:shadow-[0_0_0_1px_var(--destructive),0_0_4px_oklch(from_var(--destructive)_l_c_h_/_0.2)] data-[invalid]:focus:shadow-[0_0_0_1px_var(--destructive),0_0_4px_oklch(from_var(--destructive)_l_c_h_/_0.2)]",
