  ...
  return (
    <Tabs.List
      className={cn(
        ...
        "rounded-br-none rounded-bl-none border-[0.5px] border-[oklch(from_var(--border)_l_c_h_/_0.8)]",
  ...
  return (
    <Tabs.Tab
      className={cn(
        ...
        "bg-transparent px-3 py-1.5 font-[450] text-[var(--muted-foreground)] text-sm",
        ...
        "data-[selected]:border data-[selected]:border-[var(--border)] data-[selected]:bg-[var(--muted)] data-[selected]:text-[var(--foreground)]",
...
function TabsContent({
  ...
  return (
    <Tabs.Panel
      className={cn(
        "mt-0 rounded-[0_0_var(--radius)_var(--radius)] border-[0.5px] border-[oklch(from_var(--border)_l_c_h_/_0.8)]",
...
function TabsIndicator({
  ...
  return (
    <Tabs.Indicator
      className={cn(
        "absolute rounded-[var(--radius)] bg-[var(--primary)] transition-all duration-150 ease-in-out",
