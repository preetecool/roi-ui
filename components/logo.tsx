...
export function Logo({ width, height, className = "", fillColor, strokeColor }: LogoProps) {
  ...
  return (
    <svg width={width} height={height} viewBox="0 0 463.07 349.31" className={className}>
      <g>
        <path
