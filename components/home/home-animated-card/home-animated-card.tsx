        ...
        {isExpanded ? (
          <motion.div className={styles.cardExpanded} layoutId="card" style={{ borderRadius: "24px" }}>
            <motion.img
              ...
              width={260}
            />
            <motion.div className={styles.wrapperExpanded} layoutId="text-wrapper">
              <motion.h2 className={styles.titleExpanded} layoutId="title">
                {cardData.title}
              </motion.h2>
              <motion.p className={`${styles.description} ${styles.descriptionExpanded}`} layoutId="description">
                {cardData.description}
              </motion.p>
              <motion.p animate={{ opacity: 1 }} className={styles.longDescription} initial={{ opacity: 0 }} layout>
        ...
        {!isExpanded && (
          ...
          >
            <motion.img
              ...
              width={60}
            />
            <motion.div className={styles.wrapperCollapsed} layoutId="text-wrapper">
