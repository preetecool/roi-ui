...
export function InstallationTabsContent({ children, ...props }: React.ComponentProps<typeof BaseTabsContent>) {
  return (
    <BaseTabsContent style={{ margin: 0, border: "none", padding: 0, backgroundColor: "transparent" }} {...props}>
      {children}
    </BaseTabsContent>
  );
}
